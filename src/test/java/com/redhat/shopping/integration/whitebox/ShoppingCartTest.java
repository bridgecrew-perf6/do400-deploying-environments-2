...
public class ShoppingCartTest {
	...
	@Test
	void addNonExistingProductInCatalogRaisesAnException(){
		assertThrows(
				ProductNotFoundInCatalogException.class, () -> this.cartService.addProduct(9999, 10)
				);

	}
	@Test
	void addingNonExistingProductInCartTheTotalItemsMatch()
	...
	@Test
	void addingNonExistingProductInCartTheTotalItemsMatchTheSumOfQuantities()
		throws ProductNotFoundInCatalogException {
		this.cartService.addProduct(1,10);
